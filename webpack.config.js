...
module.exports = [{
  ...
  entry: {
    ...
    expansionPanel: [path.resolve('./packages/mdc-expansion-panel/index.js')],
  ...
  entry: {
    ...
    'mdc.expansion-panel': path.resolve('./packages/mdc-expansion-panel/mdc-expansion-panel.scss'),
